  ...
  return (
    <div className="flex flex-col items-center py-16 mx-5 transition-colors duration-300">
      ...
      <div className="name mt-10 flex flex-wrap justify-center gap-6">
        <button className="bg-yellow-300 dark:bg-yellow-500 hover:bg-yellow-400 dark:hover:bg-yellow-600 text-black dark:text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors duration-300">
          About Me
        </button>
        <button className="bg-gray-900 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors duration-300">
          View My Projects
        </button>
      </div>
    </div>
