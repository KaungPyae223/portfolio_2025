...
const NavBar = () => {
  ...
  return (
    <div className="py-10 md:py-5 flex justify-center w-full z-50">
      <div className="bg-white dark:bg-gray-900 border border-white/20 shadow-lg p-3 rounded-full flex items-center gap-5 transition-colors">
